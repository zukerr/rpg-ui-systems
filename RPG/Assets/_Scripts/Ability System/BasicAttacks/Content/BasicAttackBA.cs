...
[CreateAssetMenu(fileName = "New BasicAttackAbility", menuName = "Ability/BasicAttackAbility/BasicAttack")]
public class BasicAttackBA : BasicAttackAbility
{
    private float damageValue = 0;

    public BasicAttackBA()
    {
