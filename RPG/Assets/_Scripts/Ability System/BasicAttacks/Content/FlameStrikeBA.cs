...
[CreateAssetMenu(fileName = "New BasicAttackAbility", menuName = "Ability/BasicAttackAbility/FlameStrike")]
public class FlameStrikeBA : BasicAttackAbility
{
    private float damageValue = 0;

    public FlameStrikeBA()
    {
